...
public class MyAction 
    extends AbstractDescribableImpl<MyAction> 
    implements RootAction, Describable<MyAction> {
    ...
    public MyAction(final String goalType)
    {
    ...
    @Extension
    public static final class DescriptorImpl extends Descriptor<MyAction> {
